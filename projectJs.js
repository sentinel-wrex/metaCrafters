...
mintNFT("Max", "Black", "Sweatshirt", "Diamond chain");
mintNFT("Sam", "Red", "T-Shirt", "Diamond Ring");
mintNFT("Jack", "Yellow", "Shirt", "Diamond Bracelet");
mintNFT("Joe", "Green", "Hoodie", "Diamond glasses");
